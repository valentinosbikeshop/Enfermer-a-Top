...
const Hero = () => {
  ...
  return (
    <section id="inicio" className="relative w-full bg-primary/10 overflow-hidden">
      <div className="container mx-auto px-4 py-16 md:py-24 flex flex-col md:flex-row items-center gap-8">
        ...
        <div className="flex-1 space-y-6 text-center md:text-left z-10">
          <h1 className="text-4xl md:text-6xl font-bold text-slate-800 leading-tight">
            Bienvenido a <span className="text-primary">Enfermería Top</span>
          </h1>
          ...
          <div className="pt-4">
            <Link to="/catalogo" className="inline-block bg-primary text-white px-8 py-3 rounded-full font-semibold hover:bg-primary/90 transition-all shadow-md hover:shadow-lg transform hover:-translate-y-1">
              Ver Catálogo
            </Link>
          </div>
        </div>
